...
const messages = Messages.loadMessages('sfpowerkit', 'matchingrule_activate');
  ...
  `,
    ...
    public async execute(): Promise<AnyJson> {
        ...
        if (fs.existsSync(path.resolve(resultFile))) {
            ...
            this.ux.log(`Deploying Activated Matching Rule with ID  ${deployId.id}  to ${this.org.getUsername()}`);
