...
const messages = Messages.loadMessages('sfpowerkit', 'connectedapp_retrieve');
...
export default class Retrieve extends SFPowerkitCommand {
  ...
  `,
    ...
    public async execute(): Promise<AnyJson> {
        ...
        if (!metadata_retrieve_result.zipFile) throw new SfdxError('Unable to find the requested ConnectedApp');
