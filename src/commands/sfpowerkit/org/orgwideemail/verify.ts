...
const messages = Messages.loadMessages('sfpowerkit', 'orgwideemail_verify');

export default class OrgWideEmail extends SFPowerkitCommand {
    public static description = messages.getMessage('orgWideEmailVerifyCommandDescription');
  ...
  `,
    ...
    public async execute(): Promise<any> {
        ...
        let response = await this.org.getConnection().request({
            ...
            url: '/services/data/v' + apiversion + '/sobjects/OrgWideEmailAddress/' + id,
