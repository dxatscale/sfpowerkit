...
export default class UpdateVariable extends SfdxCommand {
  ...
  protected static flagsConfig = {
    ...
    pat: flags.string({
      required: true,
      char: "p",
      description: messages.getMessage("patFlagDescription")
    }),
    key: flags.string({
      required: true,
      char: "k",
      description: messages.getMessage("keyFlagDescription")
    }),
    value: flags.string({
      required: true,
      char: "v",
    ...
    id: flags.string({
      required: true,
      char: "i",
      description: messages.getMessage("variablegroupIdFlagDescription")
    }),
