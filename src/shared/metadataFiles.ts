...
export default class MetadataFiles {
    ...
    public static getNameOfTypes(filename: string): string {
        ...
        else if (filename.endsWith('.dashboard-meta.xml')|| filename.endsWith('.dashboardFolder-meta.xml')) {
            name = 'Dashboard';
        }
        else if (filename.endsWith('.document-meta.xml')) {
            name = 'Document';
        }
        else if (filename.endsWith('.email-meta.xml') || filename.endsWith('.emailFolder-meta.xml')) {
            name = 'EmailTemplate';
        }
        ...
        else if (filename.endsWith('.report-meta.xml')|| filename.endsWith('.reportFolder-meta.xml')) {
            name = 'Report';
        }
