...
export default class DiffUtil {
    ...
    > {
        ...
        const auraRegExp = new RegExp(METADATA_INFO.AuraDefinitionBundle.directoryName);
        ...
        if (filePath.endsWith('Translation-meta.xml') && filePath.indexOf('globalValueSet') < 0) {
            ...
            for (let i = 0; i < filePathParts.length; i++) {
                ...
                if (
                    ...
                    filePathParts[i] === METADATA_INFO.AuraDefinitionBundle.directoryName ||
                    filePathParts[i] === METADATA_INFO.LightningComponentBundle.directoryName
                ) {
