...
export default class CustomLabelsDiff {
    ...
    private static updateOutput(customLabelObj, resultOutput: any[], action, filePath) {
    ...
    private static buildDestructiveChanges(deletedCustomLabels: any, destructivePackageObj: any[]) {
    ...
    private static writeCustomLabel(newCustomLabelsObj: any, outputFilePath: string) {
